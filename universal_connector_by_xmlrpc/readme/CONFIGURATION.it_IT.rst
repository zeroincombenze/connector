...
#. Impostare protocollo "By Odoo XML-RPC (oerplib3)"
#. Impostare nome host dove l'istanza remota di Odoo è in esecuzione
#. Impostare porta di comunicazione (di solito Odoo usa 8069)
#. Dichiarare nome database remoto
#. Dichiarare nome utente remoto e password (la password non è visibile)
#. Dichiarare identità Odoo
#. Dichiarare la versione remota di Odoo
