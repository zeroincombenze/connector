...
#
"""Universal connector base tests (xmlrpc-oerlib)
...
TEST_SYNCHRO_BACKEND = {
    "universal_connector_openerp.backend_openerp7": {
        ...
        "protocol_id": "universal_connector_by_xmlrpc.protocol_xmlrpc",
        "port": 8167,
        "login": "admin",
        "password": "admin",
        "prefix": "oe7",
...
class MyTest(SingleTransactionCase):
    ...
    def _test_check_connection(self, xref):
        ...
        self.assertEqual(backend.pylib, "oerplib3")
    ...
    def test_connection(self):
        ...
        _logger.info(
            "🎺 Starting connection test on ports 8167 (db=demo7) and 8168 (db=demo8)"
        )
