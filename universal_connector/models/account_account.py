...
class AccountAccount(models.Model):
    ...
    #     """
    #     name = vals.get("name")
    #     if rec and rec.user_type_id:
    #         vals["user_type_id"] = rec.user_type_id.id
    #     elif (
    #         name
    #         and (
    #             not vals.get("user_type_id")
    #             or vals["user_type_id"]
    ...
    #                 vals["user_type_id"] = self.env.ref(RE_NAME_2_UTYPE[regex]).id
    #                 break
    #     elif not rec:
    #         vals["user_type_id"] = self.env.ref(RE_NAME_2_UTYPE[""]).id
    ...
    #     if acct.type in ("payable", "receivable") and (not rec or not rec.reconcile):
    #         vals["reconcile"] = True
    #     return vals
    #
    # @api.model
    # def synchro(
    #       self, vals, chk_in_queue=None, no_deep_fields=None, only_minimal=None):
