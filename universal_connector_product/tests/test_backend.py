...
TEST_SYNCHRO_BACKEND = {
    "universal_connector_base.backend_odoo14": {
        ...
        "login": "admin",
        "password": "admin",
        "counterpart_url": "http://admin@localhost:8174/xmlrpc/2/common",
        "counterpart_data_url": "http://admin@localhost:8174/xmlrpc/2/object",
        "prefix": "odoo14",
        "sequence": 10,
    },
    ...
    "universal_connector_base.backend_odoo10": {
        ...
        "login": "admin",
        "password": "admin",
        "counterpart_url": "http://admin@localhost:8170/xmlrpc/2/common",
        "counterpart_data_url": "http://admin@localhost:8170/xmlrpc/2/object",
        "prefix": "odoo10",
        "sequence": 14,
    },
}
