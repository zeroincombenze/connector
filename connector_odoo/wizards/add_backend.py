...
class WizardModel(models.TransientModel):
    ...
    to_export_ids = fields.Many2many(
        string="Product Templates To export",
        comodel_name="product.template",
        default=get_default_products,
    )

    categ_to_export_ids = fields.Many2many(
        string="Category To export",
