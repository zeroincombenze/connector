odoo.define('magenot_bridge.mob_dashboard', function (require) {
'use strict';

var kanban_widgets = require('web_kanban.widgets');

var MobDashboardGraph = kanban_widgets.AbstractField.extend({
    start: function() {
...
kanban_widgets.registry.add('mob_dashboard_graph', MobDashboardGraph);
