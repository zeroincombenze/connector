...
#
"""Universal connector base tests (http)
...
TEST_SYNCHRO_BACKEND = {
    "universal_connector_base.backend_odoo14": {
        ...
        "login": "admin",
        "password": "admin",
        "counterpart_url": "http://admin@localhost:8174",
        "counterpart_data_url": "http://admin@localhost:8174",
        "prefix": "odoo14",
        "sequence": 10,
    },
    ...
    "universal_connector_base.backend_odoo10": {
        ...
        "login": "admin",
        "password": "admin",
        "counterpart_url": "http://admin@localhost:8170",
        "counterpart_data_url": "http://admin@localhost:8170",
        "prefix": "odoo10",
        "sequence": 14,
    },
}
